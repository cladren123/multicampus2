...
class inflatorTestActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // setContentView 는 매개변수로 전달된 xml 문서를 layoutinflater가 inflate를 해서 화면에 뷰가
        //보여진다. - 메소드 내부에서 처리
        ...
        // 버튼이 눌려지면 include_view.xml 을 화면으로 만들어서 include_container에 붙이기
        ...
        btnAdd.setOnClickListener{
            ...
            /*
                ...
                3. true(바로 화면에 만들어서 추가하고자 하는지 유무))
                 ---------
                attachRoot가 true 일 경우 생성되는 뷰를 2번에서 부모로 지정한 뷰에 child로 추가
