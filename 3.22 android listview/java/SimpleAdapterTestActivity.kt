...
class SimpleAdapterTestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 리스트뷰에 출력할 데이터가 한 개가 아니라 여러 개 이므로 어떤 뷰에
        // 어떤 데이터를 연결해서 보여줄 지를 정확하게 명시
        val adapter = SimpleAdapter(this,
                            listdata,   // 연결할 데이터
                            android.R.layout.simple_list_item_2, // 한 row에 대한 디자인 리소스
                            arrayOf("name","telNum"), // HashMap에 key 목록을 배열로 정의
