...
import com.example.adaoterview.customizing.MyAdapter
import com.example.adaoterview.customizing.MyAdapter_step02
import com.example.adaoterview.customizing.User
...
class CustomAdapterTest : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for(i in 1..20)
        {
            val user = User(R.drawable.android, "name$i", "0000$i")
            datalist.add(user)
        }
